...
<body>
<div id="main">
	<h4 id="main_heading">Delete Files </h4>
<form action="" method="post" name="search" onsubmit="return chk()">
	<input type="text" name="Student_id" placeholder=" FILE ID" id="search"><br>
...
{
$id=$_POST['Student_id'];
$sql="SELECT *FROM files_download WHERE file_id = '$id'";
...
if($fire)
{
	...
	if($found === 1)
	{
		$query="DELETE FROM files_download WHERE file_id = '$id'";
