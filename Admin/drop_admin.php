...
<body>
<div id="main">
	<h4 id="main_heading">Drop Admin Information</h4>
<form action="" method="post" name="search" onsubmit="return chk()">
	<input type="text" name="Student_id" placeholder="username" id="search"><br>
...
if($fire)
{
	...
	if($found === 1)
	{
		...
		if($fire)
		{
			echo "<script> alert('Admin Drop Successfully'); </script>";
		}
		else
		{
				echo "<script> alert('Admin Drop Not Successfully'); </script>";
