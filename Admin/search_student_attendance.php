...
<body>
<div id="main">
	<h4 id="main_heading">Search Student Attendance</h4>
...
if($fire)
{
	...
	{
		$_SESSION['id']=$id;
		header("Location:search_student_attendance_result.php");
	}
	else
	{
...
{
		echo "<h2 style='font-family:Agency Fb;text-align:center;font-size:1.7em;'>Error Occured</h2>";
}
}
?>
