...
$sql="SELECT *FROM attendance WHERE class = '$id' AND section ='$section'";
...
if($fire)
{
	...
	if($found > 1)
	{
		...
		header("Location:resut_class_attendance.php");
...
<body>
<div id="main">
	<h4 id="main_heading"> Result Information</h4>
