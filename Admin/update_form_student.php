...
<body>
<div id="form_sing_up">
<h3 id="main_heading" style="font-family: Agency Fb">Update  Form</h3>	
<form action="update_student_catch.php" method="post" name="form_sign_up" onsubmit="return chk();"  enctype="multipart/form-data">
...
<?php if($gender == "Male") echo 'checked'; ?>><label>Male </label><br>
<input type="radio"   name="gender" value="Female" 
<?php if($gender == "Female") echo 'checked'; ?>> <label>Female </label><br>
